...
describe ArticlesController do
    ...
    context 'when authorized' do
      ...
      context 'when invalid parameters provided' do
        ...
        it 'should return 422 status code' do
          ...
          # unprocessable_entity はバリデーションエラーが発生した場合に返す
    ...
    context 'when authorized' do
      ...
      context 'when invalid parameters provided' do
        ...
        it 'should return proper error json' do
          ...
          # title と content のみの更新なので slug は必要ないので削除する
          expect(json['errors']).to include(
            {
              "source" => { "pointer" => "/data/attributes/title" },
              "detail" => "can't be blank"
  ...
  describe '#destroy' do
    ...
    subject { patch :destroy, params: { id: article.id } }
    ...
    context 'when trying to remove not owned article' do
      ...
      subject { patch :destroy, params: { id: other_article.id } }
      before { request.headers['authorization'] = "Bearer #{access_token.token}" }
