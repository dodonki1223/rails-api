...
RSpec.describe AccessTokensController, type: :controller do
  describe 'POST #create' do
    let(:params) do
      {
        data: {
          attributes: { login: 'dodonki1223', password: 'secret' }
        }
      }
    end
    ...
    context 'when invalid password provided' do
      let(:user) { create :user, login: 'dodonki1223', password: 'invalid' }
      subject { post :create, params: params }
    ...
    context 'when invalid code provide' do
